...
import { Avatar, Autocomplete, styled, Badge, Box, Button, Checkbox, FormControlLabel, FormLabel, TextField, Container, IconButton, OutlinedInput, InputAdornment, InputLabel, Radio, RadioGroup, Stack, Typography } from '@mui/material';
    ...
    return (
        <Container sx={{ background: '#dde0e7', padding: 0, m: '90px 0' }}>
            ...
            >
                ...
                <Button sx={{ alignItems: 'center', m: '45px auto' }} variant="contained" endIcon={<Send />} onClick={() => location = "/"}>
                    Register
                </Button>
            </Box>
